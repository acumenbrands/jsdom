...
exports.createWindow = function(dom, options) {
  ...
  function DOMWindow(options) {
    ...
    this.Image = function Image() {
      img = dom.Document.prototype.createElement.call(window.document, "IMG");
      // I don't know why Images created this way don't have querySelector or querySelectorAll on them,
      // but I couldn't figure out the correct way to add them in a reasonable amount of time. And
      // besides, who in their right mind would nest stuff inside of an <img> tag?
      //    - jdc 06/2013
      img.querySelectorAll = function(){
        return new dom.NodeList();
      }
      img.querySelector = function(){
        return new dom.Node();
      }
      return img
    };
